...
static const struct panel_init_cmd ws_panel_10_1_a_2lane_init[] = {
	_INIT_DCS_CMD(0xE0, 0x00),
	_INIT_DCS_CMD(0xE1, 0x93),
	_INIT_DCS_CMD(0xE2, 0x65),
	_INIT_DCS_CMD(0xE3, 0xF8),
...
static const struct panel_init_cmd ws_panel_8_a_2lane_init[] = {
	_INIT_DCS_CMD(0xE0, 0x00), _INIT_DCS_CMD(0xE1, 0x93),
	_INIT_DCS_CMD(0xE2, 0x65), _INIT_DCS_CMD(0xE3, 0xF8),
...
static const struct drm_display_mode ws_panel_10_1_a_2lane_mode = {
	.clock = 70000,
	.hdisplay = 800,
	.hsync_start = 800 + 40,
	.hsync_end = 800 + 40 + 20,
...
static const struct ws_panel_desc ws_panel_10_1_inch_a_desc = {
	.init = ws_panel_10_1_a_2lane_init,
	.mode = &ws_panel_10_1_a_2lane_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO_HSE | MIPI_DSI_MODE_VIDEO |
		      MIPI_DSI_MODE_LPM | MIPI_DSI_CLOCK_NON_CONTINUOUS,
	.lanes = 2,
	.format = MIPI_DSI_FMT_RGB888,
...
static const struct ws_panel_desc ws_panel_8_inch_a_desc = {
	.init = ws_panel_8_a_2lane_init,
	.mode = &ws_panel_8_a_2lane_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO_HSE | MIPI_DSI_MODE_VIDEO |
		      MIPI_DSI_MODE_LPM | MIPI_DSI_CLOCK_NON_CONTINUOUS,
	.lanes = 2,
	.format = MIPI_DSI_FMT_RGB888,
